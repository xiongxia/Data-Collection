...
/**
  * 函数功能: 1900年到2099年农历查询、2000年到2050年节气查询
  * 输入参数: month_p     月份
  *           table_addr  数据表位置   
  * 返 回 值: 1 该月为大，0 该月为小
  * 说    明: 无
...
/**
  * 函数功能: 输入公历日期得到一个甲子年(只允许1901-2099年)
  * 输入参数: year   公历年
  *           p      储存星期地址
  * 返 回 值: 无
  * 说    明: 无
...
/**
  * 函数功能: 输入公历日期得到本月24节气日期 day<15返回上半月节气,反之返回下半月	
  * 输入参数: year   公历年
  *           month  公历月
  *           day    公历日
  *           str    储存农历日期字符串地址   15Byte
